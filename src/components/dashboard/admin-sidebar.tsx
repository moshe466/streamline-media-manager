...
export function AdminSidebar({ handleLogout }: AdminSidebarProps) {
  ...
  return (
    <Sidebar side="left" className="border-r border-cyan-500/10 bg-slate-950/85 backdrop-blur-xl">
      <SidebarHeader>
      ...
      <SidebarContent>
        <SidebarMenu className="px-4 space-y-1">
            ...
            <SidebarMenuItem key={item.href}>
                ...
                className="justify-start rounded-xl border border-transparent text-slate-300 hover:border-cyan-400/20 hover:bg-cyan-500/10 hover:text-cyan-100 data-[active=true]:border-cyan-400/30 data-[active=true]:bg-cyan-500/15 data-[active=true]:text-cyan-100"
                >
      ...
      <SidebarFooter className="p-4 border-t border-cyan-500/10">
        <SidebarSeparator />
         <SidebarMenuItem>
